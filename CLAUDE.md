...
This CLAUDE.md works in concert with a library of 17 specialist skills organized in `skills/`. Each skill is a deep-domain expert that activates on demand via slash commands (e.g., `/polychronos-team`). Use `/list-skills` to see the full inventory. Skills are designed to compose -- the Polychronos Team orchestrator can call on any other skill as needed.
...
### AI & Strategy (`skills/strategy/`)
- **ai-agentic-specialist** — Bleeding-edge AI landscape intelligence. LLM evaluation, agentic team design, cost-saving strategies.
- **business-genius** — Entrepreneurial strategy, niche identification, market sizing, competitive moat building.
...
- **brand-website-strategy** — Brand identity, visual systems, website architecture, SEO, content strategy, conversion optimization.
